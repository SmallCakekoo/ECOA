        ...
        <div class="plant-metrics">
          <div class="metric">
            ...
            <div class="metric-bar">
              <div class="metric-fill" style="width: ${plant.water_level}%"></div>
            </div>
          </div>
          <div class="metric">
            <span class="metric-label">Luz:</span>
            <div class="metric-bar">
              <div class="metric-fill" style="width: ${plant.light_level}%"></div>
            </div>
          </div>
        </div>
...
function showFormLoading(show = true) {
  const submitBtn = document.querySelector('#overlayPlantForm button[type="submit"]');
  if (submitBtn) {
    if (show) {
