    ...
    this.shadowRoot.innerHTML = `
      ...
      <div class="container">
        ...
        <div class="form-section">
          <h1 class="title">Discover nature, grow with us!</h1>
          ...
          <form class="signup-form">
            <div class="input-group">
              ...
              <div class="input-wrapper">
                <svg class="input-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect x="3" y="5" width="18" height="14" rx="2" stroke="#7EB234" stroke-width="2"/>
                  <path d="M3 7l9 6 9-6" stroke="#7EB234" stroke-width="2" stroke-linecap="round"/>
                </svg>
            ...
            <div class="input-group">
              ...
              <div class="input-wrapper">
                ...
                <button type="button" class="eye-icon" data-target="password">
            ...
            <div class="input-group">
              ...
              <div class="input-wrapper">
                ...
                <button type="button" class="eye-icon" data-target="repeat-password">
                  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" stroke="#7EB234" stroke-width="2"/>
                    <circle cx="12" cy="12" r="3" stroke="#7EB234" stroke-width="2"/>
                  </svg>
            ...
            <div class="signin-text">
              Already have account? <a href="#" class="signin-link">Sing In</a>
            </div>
            
            <button type="submit" class="signup-btn">Sing Up</button>
          </form>
        </div>
      </div>
    `;
  ...
  attachEventListeners() {
    ...
    eyeIcons.forEach(eyeIcon => {
      eyeIcon.addEventListener("click", () => {
        ...
        const passwordInput = this.shadowRoot.querySelector(`#${targetId}`);
    ...
    form.addEventListener("submit", (e) => {
      ...
      const repeatPassword = this.shadowRoot.querySelector("#repeat-password").value;
    ...
    signinLink.addEventListener("click", (e) => {
      e.preventDefault();
      this.dispatchEvent(
        new CustomEvent("navigate-signin", {
          bubbles: true,
          composed: true,
        })
      );
  ...
  getStyles() {
    return `
      ...
      .container {
        width: 100%;
        min-height: 100vh;
        background: linear-gradient(180deg, #7EB234 0%, #7EB234 45%, #f5f5f0 45%, #f5f5f0 100%);
        position: relative;
        overflow: hidden;
      }
